...
var server = http.createServer(function (request, response) {
    ...
    else if(request.url === '/images/machfive.jpg'){
        fs.readFile('./images/machfive.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
    }
    else if(request.url === '/images/turtlevan.jpg'){
        fs.readFile('./images/turtlevan.jpg', function(errors, contents){
            response.writeHead(200, {'Content-type': 'image/jpg'});
            response.write(contents);
            response.end();
        })
