...
def success():
    ...
    message_query = "SELECT users.first_name, users.last_name, messages.message, messages.created_at FROM users JOIN messages on users.id = messages.user_id ORDER BY messages.created_at DESC"
